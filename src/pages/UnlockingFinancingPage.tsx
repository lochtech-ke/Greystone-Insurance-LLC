        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            <div className="space-y-6">
              ...
              <p className="text-slate-300 leading-relaxed">
                The haircut exists because the lender bears risk: if the asset is lost, damaged, or defaults, the collateral value evaporates. But when a Greystone <strong className="text-[#D4AF37]">Loss-Payee Endorsed</strong> policy is attached to that cargo, the risk is transferred to an A-rated underwriting syndicate. The lender's exposure to asset impairment is eliminated — and so is the haircut.
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={scenario} className={`p-5 rounded-xl border relative overflow-hidden ${highlight ? 'bg-[#202632] border-[#D4AF37]/50' : 'bg-[#181C24] border-white/10'}`}>
                    {highlight && <div className="absolute top-0 left-0 bottom-0 w-1 bg-[#D4AF37]" />}
                    <div className={`text-xs font-bold uppercase tracking-wider mb-3 ${highlight ? 'text-[#D4AF37]' : 'text-slate-400'}`}>{scenario}</div>
                    <div className="grid grid-cols-3 gap-3 text-center">
                      ...
                      <div>
                        ...
                        <div className={`font-cinzel text-lg font-bold ${highlight ? 'text-[#D4AF37]' : 'text-slate-500 line-through'}`}>{haircut}</div>
                      </div>
                      <div>
                    ...
                    <p className={`text-xs mt-3 text-center ${highlight ? 'text-[#D4AF37] font-semibold' : 'text-slate-500'}`}>{marginNote}</p>
                  </div>
                ))}
                <div className="p-4 rounded bg-[#11141A] border border-white/5 text-center">
          ...
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={title} className="p-6 rounded-xl bg-[#181C24] border border-white/8 space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="font-cinzel text-lg font-black text-[#D4AF37]/40">{String(i + 1).padStart(2, '0')}</span>
